...
DEFAULT_SUMMARY = Path("data/processed/weather/cleaning.csv")
DEFAULT_COVERAGE = Path("data/processed/weather/station_coverage.csv")
DEFAULT_FROZEN = Path("data/processed/weather/frozen_zero.csv")
