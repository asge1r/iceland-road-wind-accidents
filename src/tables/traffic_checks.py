...
DEFAULT_ALL_PERIODS = Path("reports/main/tables/wind_rate.csv")
DEFAULT_OFFICIAL = Path("reports/working/tables/wind_rate_official.csv")
DEFAULT_DAILY = Path("data/analysis/daily_traffic.csv")
DEFAULT_ANNUAL_QUALITY = Path("reports/main/tables/annual_quality.csv")
DEFAULT_OUTPUT = Path("reports/main/tables/traffic_checks.csv")
