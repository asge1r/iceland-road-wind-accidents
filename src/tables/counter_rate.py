...
from src.analysis.traffic_rate import fit_daily_rate_model as fit_model
...
STANDARD_OUTPUT = Path("reports/main/tables/day_rate.csv")
COARSE_OUTPUT = Path("reports/main/tables/day_rate_coarse.csv")
STANDARD_AUDIT = Path("reports/working/tables/day_rate_audit.csv")
COARSE_AUDIT = Path("reports/working/tables/day_rate_coarse_audit.csv")
