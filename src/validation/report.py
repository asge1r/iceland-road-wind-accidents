...
def write_report(values: dict[str, object], output: Path) -> None:
    ...
    lines.extend(
        [
            ...
            "The counter-section vehicle-kilometre table partitions linked daytime accidents into non-overlapping minor-injury and severe/fatal groups. Observed daily totals are allocated by station-calendar-month weather frequencies pooled across 2007–2025, restricted to 07:00–24:00. Rates are per million estimated vehicle-km; event bins use actual accident-time weather.",
