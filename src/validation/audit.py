...
def validation_values(
    ...
    oe_results_path: Path, daily_path: Path, daily_accident_weather_path: Path,
    ...
    case_control_result_path: Path, radius_result_path: Path,
    traffic_checks_path: Path, daily_rate_path: Path,
    ...
    values = validate_weather(
        accidents_path, conditions_path, weather_audit_path, mean_wind_path,
        temperature_path, coverage_path, oe_results_path,
    )
    ...
    values.pop("_mean_wind")
    values.pop("_oe_results")
