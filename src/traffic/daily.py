...
row per physical counter site and date to ``daily_raw.csv``. It does
...
OUT_COUNTS = Path("data/processed/traffic/daily_raw.csv")
...
def extract(
    ...
    counter_days[count_columns].to_csv(counts_output, index=False)
