...
\node[anchor=center,inner sep=0pt] at ([yshift=-3.5mm]current page.center){\includegraphics[height=6.65cm,keepaspectratio]{conditions.pdf}};
...
{\small Vetur: desember--mars · 2007--2025 · meðalvindur $\geq20$ m/s\par}
\[
\text{Vænt slys}=\text{slys alls í hópnum}\times\text{veðurtíðni}
\]
\vspace{2mm}
\renewcommand{\arraystretch}{1.4}
\begin{tabular}{@{}lrrr@{}}\toprule
Veðurstöð & \shortstack{Slys alls\\í hópnum} & \shortstack{Tíðni vinds\\$\geq20$ m/s} & Vænt slys\\\midrule
Ingólfsfjall & 61 & 0,082\% & 0,05\\
Reykjanesbraut & 91 & 0,803\% & 0,73\\\bottomrule
\end{tabular}\par
\vspace{5mm}
Væntir fjöldar allra stöðvar--árstíðarhópa eru lagðir saman: 31,6 slys.
\end{frame}
...
\node[anchor=center,inner sep=0pt] at ([yshift=-6.5mm]current page.center){\includegraphics[height=6.1cm,keepaspectratio]{joint_wind_temperature_detail.pdf}};
