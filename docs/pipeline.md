...
| `figures/daily_allocated_rate.py` | Daily allocated-rate result tables | *reports/main/figures/*<br>`daily_allocated_rate_ratio_by_wind.png`<br>`daily_allocated_rate_serious_fatal_by_wind.png` | Draws the retained daily-counter rate ratios. |
...
| `tables/rate.py` | `analysis/conditional_poisson_input.csv` | *reports/main/tables/*<br>`conditional_poisson_rate_ratio_by_wind.csv`<br>`conditional_poisson_rate_ratio_serious_fatal_by_wind.csv` | Estimates injury and serious/fatal road-, year- and period-stratified rate ratios. |
| `figures/rate.py` | Conditional Poisson rate tables | Two matching rate-ratio figures | Draws injury and serious/fatal rate ratios. |
