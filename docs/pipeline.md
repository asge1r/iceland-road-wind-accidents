...
- `export_docs.py` owns the generated analysis-layer README and manifest, so
  documentation rendering is separate from data selection.
...
| `tables/rate.py` | `analysis/road_rate.csv` | *reports/main/tables/*<br>`wind_rate.csv`<br>`wind_rate_severity.csv`<br>*reports/working/tables/*<br>`wind_rate_official.csv` | Fits the annual-traffic rate models. |
| `figures/rate.py` | The three tables written by `tables/rate.py` | *reports/main/figures/*<br>`wind_rate.png`<br>`wind_rate_severity.png`<br>*reports/working/figures/*<br>`wind_rate_official.png` | Draws the annual-traffic rate ratios. |
...
| `figures/daily_traffic.py` | `reports/main/tables/traffic_wind.csv` | `reports/main/figures/traffic_wind.png` | Draws the supporting daily-traffic result. |
...
- Seasonal temperature display: below 1, 1–5, and at least 5°C; these are sums of the fixed O/E intervals.
