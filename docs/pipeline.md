...
| `tables/daily_season_fine_audit.py` | The same daily-counter inputs | `reports/main/tables/daily_season_fine_audit.csv` | Checks whether 5 m/s seasonal cells contain enough accidents for reporting. |
