...
| `accidents/rural_injury_accidents_weather.parquet` | one rural injury accident | accident fields plus matched weather station, time difference, distance, `f`, `fg`, `t` |
