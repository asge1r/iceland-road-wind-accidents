...
| `analysis/daily_weather_rate.csv` | Weather variable, outcome, period, and interval | 07:00--24:00 accident counts, allocated vehicle-km, and rates per million vehicle-km from daily counters. |
